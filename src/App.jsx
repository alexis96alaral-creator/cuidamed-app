...
export default function App() {
  ...
  function handleConfirmar() {
    ...
    const url = buildWhatsAppURL({ nurse: selectedNurse, ...form });
        ...
        <>
          <div style={{ background: `linear-gradient(135deg, ${C.navy} 0%, #1D5070 50%, ${C.tealDark} 100%)`, padding: "5.5rem 2rem 4rem", textAlign: "center", position: "relative", overflow: "hidden" }}>
            ...
            <div style={{ position: "relative", zIndex: 1 }}>
              <div style={{ display: "flex", justifyContent: "center", marginBottom: "1.5rem" }}><LogoIcon size={72} white /></div>
          ...
          <div style={{ background: C.bgAlt, padding: "4rem 2rem", textAlign: "center", borderTop: `1px solid ${C.border}`, borderBottom: `1px solid ${C.border}` }}>
            ...
            <div style={{ display: "flex", justifyContent: "center", gap: "2rem", flexWrap: "wrap", maxWidth: "850px", margin: "0 auto" }}>
              {[["🔍", "Buscá un enfermero", "Filtrá por zona, especialidad y disponibilidad en Santa Cruz."], ["📋", "Solicitá el servicio", "Completá el formulario y se abre WhatsApp directo con CuidaMed."], ["🏠", "Recibí atención", "Coordinamos todo por vos. El enfermero llega a tu domicilio."]].map(([icon, t, d], i) => (
          ...
          <div style={{ maxWidth: "1100px", margin: "0 auto", padding: "3.5rem 2rem" }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", marginBottom: "1.5rem", flexWrap: "wrap", gap: "1rem" }}>
              ...
              <button style={{ background: "transparent", color: C.teal, border: `2px solid ${C.teal}`, borderRadius: "6px", padding: "0.6rem 1.2rem", fontSize: "0.875rem", fontWeight: "700", cursor: "pointer", fontFamily: "inherit" }} onClick={() => setPage("search")}>Ver todos →</button>
            </div>
            ...
            {booked ? (
              <div style={{ textAlign: "center", padding: "1.5rem 0" }}>
                ...
                <p style={{ color: C.muted, fontSize: "0.9rem", lineHeight: 1.7 }}>
                  Tu solicitud fue enviada a CuidaMed por WhatsApp. Te confirmaremos en breve.
                </p>
              ...
              <>
                ...
                <button style={{ background: "#25D366", color: C.white, border: "none", borderRadius: "8px", padding: "0.9rem", fontSize: "0.95rem", fontWeight: "700", cursor: "pointer", fontFamily: "inherit", width: "100%", display: "flex", alignItems: "center", justifyContent: "center", gap: "0.6rem", boxShadow: "0 4px 16px rgba(37,211,102,0.35)" }} onClick={handleConfirmar}>
                  ...
                  Confirmar por WhatsApp · Bs. {selectedNurse.price}
                </button>
                <p style={{ color: C.muted, fontSize: "0.72rem", textAlign: "center", marginTop: "0.75rem" }}>
                  Se abrirá WhatsApp con tu solicitud lista para enviar a CuidaMed
                </p>
              </>
            )}
          </div>
...
function NurseCard({ nurse, onSelect }) {
  ...
  return (
    <div style={{ background: C.white, borderRadius: "12px", overflow: "hidden", border: `1px solid ${C.border}`, transition: "transform 0.2s, box-shadow 0.2s", cursor: "pointer", transform: hovered ? "translateY(-4px)" : "none", boxShadow: hovered ? `0 16px 40px rgba(27,58,92,0.15)` : "0 2px 8px rgba(27,58,92,0.06)" }}
      ...
      <div style={{ padding: "1.5rem" }}>
        ...
        <button style={{ background: nurse.available ? C.teal : "#CCC", color: C.white, border: "none", borderRadius: "8px", padding: "0.75rem", fontSize: "0.88rem", fontWeight: "700", cursor: nurse.available ? "pointer" : "not-allowed", fontFamily: "inherit", width: "100%", transition: "background 0.2s" }}
